...
class Involution2d(nn.Module):
    ...
    Implement: https://github.com/ChristophReich1996/Involution
    """
    ...
    def forward(self, inputs: torch.Tensor) -> torch.Tensor:
        ...
        assert inputs.ndimension() == 4, \
            "Input tensor to involution must be 4d but {}d tensor is given".format(inputs.ndimension())
...
class Involution(nn.Module):
    ...
    def __init__(self, c1, c2, k=7, s=1, p=3, g=1, d=1, act=True):
        ...
        """
        super().__init__()
        self.conv = Involution2d(in_channels=c1, out_channels=c2, kernel_size=k, stride=s, padding=autopad(k, p, d), groups=g, dilation=d)
